...
# );
#
# INSERT INTO user (firstname, lastname, username, password, confirmpassword)
# VALUES
#     ('John', 'Doe', 'Admin1', 'senha123', 'senha123'),
#     ('Jane', 'Smith', 'Admi2', 'senha234', 'senha234'),
#     ('Bob', 'Johnson', 'Admin3', 'senha345', 'senha345'),
#     ('Sergio', 'Cassio', 'user1', 'senha456', 'senha456'),
#     ('Ted', 'Gentil', 'user2', 'senha567', 'senha567'),
#     ('Ben', 'Watson', 'user3', 'senha678', 'senha678'),
#     ('Luffy', 'Mugiwara', 'user4', 'senha789', 'senha789'),
#     ('Naruto', 'Uzumaki', 'user5', 'senha8910', 'senha8910');
#
# -- Inserção de dados na tabela 'role'
# INSERT INTO role (created_by, description, details)
# VALUES
#     ('admin', 'ADMIN', 'Detalhes da função de administrador'),
#     ('admin', 'USER', 'Detalhes da função de editor');
#
